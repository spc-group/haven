...
class IOC(IOC_):
    ...
    proposal_title = pvproperty(name="proposal:title", value="Making the world a more interesting place.")
    proposal_user_badges = pvproperty(name="proposal:userBadges", value="287341, 203884, 59208")
    proposal_user_last_names = pvproperty(name="proposal:users", value="Franklin, Watson, Crick")
    proposal_user1_badge_number = pvproperty(name="proposal:user1:badgeNumber", value="")
    ...
    proposal_user2_badge_number = pvproperty(name="proposal:user2:badgeNumber", value="")
    ...
    proposal_user3_badge_number = pvproperty(name="proposal:user3:badgeNumber", value="")
    ...
    proposal_user4_badge_number = pvproperty(name="proposal:user4:badgeNumber", value="")
    ...
    proposal_user5_badge_number = pvproperty(name="proposal:user5:badgeNumber", value="")
    ...
    proposal_user6_badge_number = pvproperty(name="proposal:user6:badgeNumber", value="")
    ...
    proposal_user7_badge_number = pvproperty(name="proposal:user7:badgeNumber", value="")
    ...
    proposal_user8_badge_number = pvproperty(name="proposal:user8:badgeNumber", value="")
    ...
    proposal_user9_badge_number = pvproperty(name="proposal:user9:badgeNumber", value="")
