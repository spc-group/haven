...
def test_metadata():
    ...
    expected_keys = [ "uid", "time", "EPICS_HOST_ARCH", "beamline_id",
                      "facility_id", "xray_source", "epics_libca",
                      "EPICS_CA_MAX_ARRAY_BYTES", "login_id", "pid",
                      "scan_id", "proposal_id", "versions",
                      "plan_type", "plan_name", "detectors",
                      "num_points", "num_intervals", "plan_args",
                      "hints", "parameters", "purpose",
                      "bss_aps_cycle", "bss_beamline_name", "esaf_id",
                      "esaf_title", "mail_in_flag", "principal_user",
